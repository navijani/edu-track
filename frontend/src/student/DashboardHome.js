                ...
                <div className="s-glass-panel" style={{ background: 'white', borderRadius: '20px', border: '1px solid #f1f5f9', boxShadow: '0 4px 15px rgba(0,0,0,0.03)' }}>
                    ...
                    <ResponsiveContainer width="100%" height={280}>
                        <LineChart data={data.growthData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                            ...
                            <Line type="monotone" dataKey="quiz" name="Quiz Scores" stroke="#10b981" strokeWidth={4} dot={{ r: 4, strokeWidth: 2, fill: 'white' }} activeDot={{ r: 8, strokeWidth: 0, fill: '#10b981' }} />
                            <Line type="monotone" dataKey="video" name="Video Progress" stroke="#3b82f6" strokeWidth={4} dot={{ r: 4, strokeWidth: 2, fill: 'white' }} activeDot={{ r: 8, strokeWidth: 0, fill: '#3b82f6' }} />
                            <Line type="monotone" dataKey="doc" name="Reading Progress" stroke="#8b5cf6" strokeWidth={4} dot={{ r: 4, strokeWidth: 2, fill: 'white' }} activeDot={{ r: 8, strokeWidth: 0, fill: '#8b5cf6' }} />
                        </LineChart>
                    </ResponsiveContainer>
                </div>
