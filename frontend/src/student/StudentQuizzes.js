...
const StudentQuizzes = ({ subjectName, user }) => {
    ...
    const fetchSubmissions = async () => {
        try {
            const response = await axios.get(`https://edu-track-c6ml.onrender.com/api/answers/quiz?studentId=${user.id}`);
    ...
    const handleSubmitQuiz = async () => {
        ...
        try {
            await axios.post('https://edu-track-c6ml.onrender.com/api/answers/quiz', {
